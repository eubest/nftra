...
import { _transactionChargeRequestedWebhook } from "@/saleor-app-checkout/pages/api/webhooks/saleor/transaction-charge-requested";
...
const handler = createManifestHandler({
  async manifestFactory(context): Promise<AppManifest> {
    ...
    return {
      ...
      webhooks: [_transactionChargeRequestedWebhook.getWebhookManifest(appBaseUrl)],
    };
  },
});
